...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/winter-moon-fecd
```

A live public deployment of this template is available at [https://winter-moon-fecd.templates.workers.dev](https://winter-moon-fecd.templates.workers.dev)
